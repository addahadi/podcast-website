    ...
    <section className="mt-12">
      ...
      <div className=" mt flex flex-row  w-full  border-2 border-black-5 ">
        <button
          ...
          className="p-4 w-3/6 text-center  items-center text-white-1 font-bold   cursor-pointer"
        >
          Generate Img
        </button>
        <button
          ...
          style={!isThumbnail ? { backgroundColor: "#242424" } : {}}
          className="p-4 w-3/6 text-center  text-white-1 font-bold  cursor-pointer"
        >
          Upload Img
        </button>
      </div>
        ...
        >
          ...
          {!loading ? (
            <div className="flex justify-center items-center flex-col gap-3">
              <img
                src="/podcast-website/icons/upload-image.svg"
                width={50}
                height={30}
              />
              <h2 className="text-12 text-red-1 font-bold">Click to upload</h2>
              <h2 className="text-12 text-white-3 font-bold">
                PNG SVG PDF max(1080p)
              </h2>
            </div>
          ) : (
            <img
