    ...
    <section className=" flex flex-col gap-8">
      ...
      <div className="flex flex-row gap-8">
        ...
        <section className="flex flex-col gap-7">
          ...
          <h1 className="text-white-1 text-2xl font-bold">
            {User.email?.split("@")[0]}
          </h1>
          <h2 className="flex flex-row items-center  gap-2 h-10">
            <img
              src="/podcast-website/icons/headphone.svg"
              width={20}
              className=" h-5"
            />
            <span className="text-white-1 font-bold text-sm">
              {" "}
              93,525,192
              <span className="text-white-3 ml-1">mounthly listners</span>
            </span>
          </h2>
          <button
            className=" bg-mouve-1  p-5 rounded-sm max-w-60 h-12 font-bold text-white-1 flex flex-row gap-2 items-center justify-center
      ...
      <section>
        <div className="flex flex-row justify-between items-center">
          ...
          <button
            className="flex flex-row gap-2 items-center bg-mouve-1 p-2 text-white-1 font-bold
          hover:border hover:text-white-1 hover:border-mouve-1 hover:bg-[#000] transition ease delay-100
          "
          >
            <img src="/podcast-website/icons/edit.svg" />
            Apply filter
          </button>
        </div>
